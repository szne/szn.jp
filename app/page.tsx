      ...
      <section className={styles.about}>
        ...
        <div>
          <div className={styles.name}>
            <h3>szne</h3>
            <Link href='https://github.com/szne'>
          ...
          <Link href='about'>もっと見る / Explore further →</Link>
        </div>
      </section>
